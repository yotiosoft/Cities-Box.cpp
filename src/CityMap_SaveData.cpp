...
bool CityMap::save() {
	...
	mapData[U"Demand"][U"office"] = m_rust_core->get_demand().office;
	mapData[U"Demand"][U"industrial"] = m_rust_core->get_demand().industrial;
	mapData[U"Demand"][U"farm"] = m_rust_core->get_demand().farm;
